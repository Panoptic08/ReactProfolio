        ...
        <div className='bg-gray-900 min-h-screen flex flex-col items-center'>
            ...
            <div className='grid grid-cols-2 gap-x-20 gap-y-10 items-center mt-20'>
                ...
                <div className='bg-black text-white p-6 rounded-lg shadow-lg items-center justify-center transform hover:scale-105 transition-transform duration-300'>
                    <img src={enigma} alt="" className='rounded-xl h-28 ml-20' />
                    <h1 className='mt-8 text-center text-xl'>Participated in an inter-College <br /> Data Science Hackathon <br /> 4th Rank <br /> team of 4 people developed a website <br /> for supply chain optimization using <br /> Python(streamlit).</h1>
                <button className='bg-blue-400 rounded py-4 px-4 text-black text-xl hover:scale-110 ml-20 mt-5 mb-5 '>Preview Project</button>
                </div>
                ...
                <div className='bg-black text-white p-6 w-auto rounded-lg shadow-lg items-center justify-center transform hover:scale-105 transition-transform duration-300' style={{marginTop: "-16%"}}>
                    ...
                    <h1 className='mt-8 text-center text-xl mb-10'>Co-Head Tech Team <br /> (IBF BU) <br /> INDIAN BLOCKCHAIN FRATERNITY</h1>
                </div>
